    ...
    <div class="contacts">
      <div class="contacts__start">
        <div class="contacts__map" id="ymap">
          <iframe src="{{ setting('site.maps') }}" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
      ...
      <div class="contacts__end">
        <div class="contacts__item">
          ...
          <p class="contacts__text">{{ setting('site.adress') }}</p>
        </div>
        <div class="contacts__item">
          <h3 class="contacts__title">
            @lang('contact.phone')
          ...
          <p class="contacts__text">
            <a class="contacts__phone" href="tel:{{ setting('site.phone') }}">{{ setting('site.phone') }}</a>
          </p>
        </div>
        <div class="contacts__item">
          <h3 class="contacts__title">
          ...
          <ul class="socials">
            <li class="socials__item">
              <a href="{{ setting('site.vk') }}" class="socials__link" target="_blank">
            ...
            <li class="socials__item">
              <a href="setting('site.facebook')" class="socials__link" target="_blank">
            ...
            <li class="socials__item">
              <a href="{{ setting('site.instagram') }}" class="socials__link" target="_blank">
